...
define("SMTP_UNAME", "Enter Username"); //Username for SMTP authentication any valid email created in your domain
define("SMTP_PWORD", "Enter Password"); //Password for SMTP authentication
